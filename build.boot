...
(task-options!
  pom {:project     'quamolit/fractal-box-tree
       :version     +version+
       :description "Quamolit is declarative animation library for Canvas"
       :url         "https://github.com/Quamolit/fractal-box-tree"
       :scm         {:url "https://github.com/Quamolit/fractal-box-tree"}
...
(deftask dev! []
  ...
  (comp
    ...
    (reload :on-jsload 'box-tree.main/on-jsload!
            :cljs-asset-path ".")
...
(deftask rsync []
  (with-pre-wrap fileset
    (sh "rsync" "-r" "target/" "repo.tiye.me:repo/Quamolit/box-tree" "--exclude" "main.out" "--delete")
    fileset))
